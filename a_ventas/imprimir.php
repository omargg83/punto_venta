<?php
	...
	$pdf->ezText("TODO PARA TUS PIES",10,array('justification' => 'center'));
	$pdf->ezText(" Blvd. Valle de San Javier 202, 42086 Pachuca de Soto, Hgo.",10,array('justification' => 'center'));
	$pdf->ezText(" ",10);
	...
	$pdf->ezText(" ",10);
	$pdf->ezText("¡Gracias por preferirnos!",12,array('justification' => 'center'));
