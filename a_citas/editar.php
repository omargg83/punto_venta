<?php
  ...
  echo "<div class='container'>";
    echo "<form id='form_comision' action='' data-lugar='a_citas/db_' data-destino='a_citas/editar' data-funcion='guardar_pedido'>";
      ...
      echo "<div class='card'>";
					...
					echo "<div class='row'>";
						echo "<div class='col-4'>";
							...
							if($estatus=='EN ESPERA' or $id==0){
								echo "<input type='text' class='form-control form-control-sm' placeholder='Click para agregar Cliente' id='winmodal_cliente' name='winmodal_cliente' value='$nombre_cli' readonly  data-id='$idcliente' data-id2='$id' data-lugar='a_citas/form_cliente' title='Click para agregar Cliente'>";
							}
							else{
        ...
        echo "<div class='card-footer'>";
          echo "<div class='btn-group'>";
	              ...
	              echo "<button type='button' class='btn btn-outline-secondary btn-sm' id='winmodal_prod' data-id='$idcliente' data-id2='$id' data-lugar='a_citas/form_producto' title='Agregar Producto' ><i class='fab fa-product-hunt'></i>+ Producto</button>";

								echo "<button type='button' class='btn btn-outline-secondary btn-sm' id='winmodal_cup' data-id='$idcliente' data-id2='$id' data-lugar='a_citas/form_cupon' title='Agregar Cupón' ><i class='fas fa-ticket-alt'></i>+ Cupón</button>";
							}
									...
									echo "<td>";
										echo "<div class='btn-group'>";
											if($estatus=='EN ESPERA'){
												echo "<button class='btn btn-outline-secondary btn-sm' id='eliminar_prodn".$key['id']."' data-lugar='a_citas/db_' data-destino='a_citas/editar' data-id='".$key['id']."' data-iddest='$id' data-funcion='borrar_prodped' data-div='trabajo'><i class='far fa-trash-alt'></i></button>";
											}
										echo "</div>";
									echo "</td>";
									echo "<td>";
