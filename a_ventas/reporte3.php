...
<form id='consulta_avanzada' action='' data-destino='a_ventas/reporte3_res' data-div='resultado'  autocomplete='off'>
  <div class='container' >
    <div class="alert alert-success" role="alert">
      <h4 class="alert-heading">Monto de ventas por mes</h4>
      <div class='row'>
        <div class='col-sm-3'>
            <label><b>Del</b></label>
...
$(function() {
  ...
  var desde= $("#desde").val();
  var hasta= $("#hasta").val();
  $("#resultado").load("a_ventas/reporte3_res.php?desde="+desde+"&hasta="+hasta);
});
</script>
